...
**ls** , **cd** , **cat** , **archivo** , **du** , **buscar** , **grep**

## Solucion

Segun las propiedades podemos usar el comando find para buscar y filtrar por esas caracteristicas, aunque podemos experimentar un poco.

Primero listamos lo que tenemos a simple vista pero vemos que no hay nada, asi que empiezo con la busque indicando solo que quiero del usario bandit7 y de tamaño 33 bytes:
...
find: ‘/proc/24/task/24/fd/6’: No such file or directory
find: ‘/proc/24/task/24/fdinfo/6’: No such file or directory
find: ‘/proc/24/fd/5’: No such file or directory
find: ‘/proc/24/fdinfo/5’: No such file or directory
...
Como podemos ver, si revisamos bien, hay dos archivos que nos llama la atencion ya que no dan permiso denegado, pero podemos hacerlo mas facil, ya sea filtrando de forma completa las caracteriticas del archivo buscado pero ademas de evitar que nos muestre el mensaje de permiso denegado para varios archivos que no nos interesan, con el siguiente comando:
...
Como podemos ver, ahora solo me aparece un solo archivo, que seria nuestra bandera, leemos con cat:
